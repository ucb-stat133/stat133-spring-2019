---
title: "Lab 4: First contact with dplyr and ggplot2"
...
knitr::opts_chunk$set(echo = TRUE, fig.path = 'lab04-images/')
library(dplyr)
library(ggplot2)
```
...
- If you attend lab, to achieve __substantial progress__ you have to complete the "Your Turn*" sections marked with a star.
...
rows, columns, or cells. In addition, you've created charts with 
functions like `plot()`, `boxplot()`, `barplot()`, and `hist()`, which are part of the `"graphics"` package.
